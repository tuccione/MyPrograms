...
void threads(int nThreads, int limite);
void * CalcolaPrimi (void * ptr, void * ptr2);

int main(int argc,char * argv[])
{
	int nThreads, limite;	/*numero di threads da creare*/
	clockid_t clk;
...
void threads(int nThreads, int limite)
{
	...
	{	ret=pthread_create(&thread[i],NULL,CalcolaPrimi,(void*) &i, (void*) &orizzonte);
